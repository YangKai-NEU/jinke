...
<html>
	<head>
		...
		<title><?php echo $confige->getItem('account_title');?>-我的账户</title>
	</head>
	<body>
		...
		<div class='account-main'>
			<div class='account-main-left cur-hand'>
				...
				<div id="account-main-left-address" class="account-text-b mouse-on-red-off-black cur-hand">收货地址设置</div>
				<div id="modify-pwd" class="account-text-b mouse-on-red-off-black cur-hand">修改密码</div>
			...
			<div class="account-main-mid">
				<div class="account-main-mid-header">
					<image src="./images/init_head.png" style="height: 80px;width:80px;"></image>
					<aaa class="account-main-mid-header-username">18940265355</aaa>
					<div class="account-main-mid-header-right">
						<a class="modify-address account-main-mid-header-right-item cur-hand mouse-on-red-off-black">修改收货地址</a>
						<a class="fenqi-record account-main-mid-header-right-item cur-hand mouse-on-red-off-black">我的分期记录</a>
						<a class="self-info account-main-mid-header-right-item cur-hand mouse-on-red-off-black">个人信息设置</a>
					</div>
				</div>
				<div class="account-main-mid-six-img">
					<div class="account-main-mid-six-item">
						<image class="cur-hand daishouhuo" src="./images/daishouhuo.png" style="height: 70px;width: 70px;margin-top: 5px;" onmouseover="this.src='./images/daishouhuo_r.png'" onmouseout="this.src='./images/daishouhuo.png'"></image>
					</div>
					<div class="account-main-mid-six-item">
						<image class="cur-hand yishouhuo" src="./images/yishouhuo.png" style="height: 70px;width: 70px;margin-top: 5px;" onmouseover="this.src='./images/yishouhuo_r.png'" onmouseout="this.src='./images/yishouhuo.png'"></image>
					</div>
					<div class="account-main-mid-six-item">
						<image class="cur-hand fenqijinxingshi" src="./images/fenqijinxingshi.png" style="height: 70px;width: 70px;margin-top: 5px;" onmouseover="this.src='./images/fenqijinxingshi_r.png'" onmouseout="this.src='./images/fenqijinxingshi.png'"></image>
					</div>
					<div class="account-main-mid-six-item">
						<image class="cur-hand meiriqiandao" src="./images/meiriqiandao.png" style="height: 70px;width: 70px;margin-top: 5px;" onmouseover="this.src='./images/meiriqiandao_r.png'" onmouseout="this.src='./images/meiriqiandao.png'"></image>
					</div>
					<div class="account-main-mid-six-item">
						<image class="cur-hand wodejifen" src="./images/wodejifen.png" style="height: 70px;width: 70px;margin-top: 5px;" onmouseover="this.src='./images/wodejifen_r.png'" onmouseout="this.src='./images/wodejifen.png'"></image>
					</div>
					<div class="account-main-mid-six-item">
						<image class="cur-hand jifenshangcheng" src="./images/jifenshangcheng.png" style="height: 70px;width: 70px;margin-top: 5px;" onmouseover="this.src='./images/jifenshangcheng_r.png'" onmouseout="this.src='./images/jifenshangcheng.png'"></image>
					</div>
				</div>
				<div class="account-main-mid-six-text">
					<div class="account-main-mid-six-text-item mouse-on-orange-off-black cur-hand">
						待收货
					</div>
					<div class="account-main-mid-six-text-item mouse-on-orange-off-black cur-hand">
						已收货
				...
				<div class="account-mid-message">
					<a class="cur-hand">系统通知</a><image class="cur-hand" src="./images/t_arrow.gif" style="margin-left: 5px; vertical-align: middle; height: 5px;line-height: 45px;"/>
				</div>
				<div class="account-mid-message-null">
					暂无消息
				</div>
			</div>
		</div>
