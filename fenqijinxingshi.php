<?php
	...
	$select = "select o_id,o_price,o_time,g_name,g_imgurl,a_address,f_month,f_ratio,o_leave,count(*) from db_order,db_transaction,db_address,
		db_goods,db_fenqi where o_address=a_id and o_id=t_oid and g_id=t_gid and o_uid='".$_SESSION['C_USER']->mId."' and o_fid=f_id and o_leave>0 and 
...
<html>
	<head>
		...
		<title><?php echo $confige->getItem('account_title');?>-分期进行时</title>
	</head>
	<body>
		...
		<div class='account-main'>
			<div class='account-main-left cur-hand'>
				...
				<div id="account-main-left-fenqijinxingshi" class="text-red account-text-l cur-hand  font17px">分期进行时</div>
			...
			<div class="account-main-mid">
				<div class="account-main-mid-receipt-header">
					...
					<div id="fenqi-order" class="order-item-text text-orange cur-hand"><strong>分期进行时</strong></div>
