...
<html>
	<head>
		...
		<title><?php echo $confige->getItem('account_title');?>-我的订单</title>
	</head>
	<body>
		...
		<div class='account-main'>
			<div class='account-main-left cur-hand'>
				...
				<div id="account-main-left-all-order" class="account-text-b text-red cur-hand font17px">我的订单</div>
			...
			<div class="account-main-mid">
				<div class="account-main-mid-receipt-header">
					<div id="all-order" class="order-item-text text-orange cur-hand"><strong>所有订单</strong></div>
