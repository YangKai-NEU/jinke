<?php
	...
	$select = "select o_id,o_price,o_time,g_name,g_imgurl,a_address,f_month,f_ratio,o_leave,count(*) from db_order,db_transaction,db_address,
		...
		o_isshow='Y' and o_receive='Y' group by t_oid";
...
<html>
	<head>
		...
		<title><?php echo $confige->getItem('account_title');?>-已收货</title>
	</head>
	<body>
		...
		<div class='account-main'>
			<div class='account-main-left cur-hand'>
				...
				<div id="account-main-left-receive" class="account-text-l text-red cur-hand font17px">已收货</div>
			...
			<div class="account-main-mid">
				<div class="account-main-mid-receipt-header">
					...
					<div id="receipt-order" class="order-item-text cur-hand mouse-on-orange-off-init"><strong>待收货</strong></div>
					<div id="receive-order" class="order-item-text text-orange cur-hand"><strong>已收货</strong></div>
