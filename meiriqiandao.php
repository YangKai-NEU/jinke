...
<html>
	<head>
		...
		<title><?php echo $confige->getItem('account_title');?>-修改密码</title>
	</head>
	<body>
		...
		<div class='account-main'>
			<div class='account-main-left cur-hand'>
				...
				<div id="account-main-left-meiriqiandao" class="account-text-b text-red cur-hand font17px">每日签到</div>
			...
			<div class="account-main-mid">
				<div class="account-main-mid-qiandao">
					...
					<input type="button" id='meiriqiandap-btn' class="cur-hand mouse-on-strong" style="border:none; margin-top:-60px;background: olivedrab; font-size:15px;color:white;height: 40px;width: 100%;" value="签到可领1积分"/>
				</div>
			</div>
		</div>
		<main id="main">
		...
		<script type="application/javascript">
			$("#meiriqiandap-btn").click(function(){
				$.ajax({
					type: "POST",
					url: "action/qiandao.class.php",
					data: {user_id:<?php echo $_SESSION['C_USER']->mId;?>
					},
					dataType: "json",
