	...
	<body>
		...
		<div class='account-main'>
			<div class='account-main-left cur-hand'>
				...
				<div id="modify-pwd" class="account-text-b cur-hand text-red">修改密码</div>
			...
			<div class="account-main-mid">
				...
				<div class="account-main-mid-pwd">
					<aaa>&nbsp; &nbsp;原密码：</aaa><input id="old-pwd" type="password"/><br/>
					<aaa>&nbsp; &nbsp;新密码：</aaa><input id="new-pwd" type="password"/><br/>
					<aaa>重复输入：</aaa><input id="repeat-pwd" type="password" /><br/>
					<input type="button" id="submit-btn" style="width: 100px;" value="确定"/>
				</div>
			</div>
		</div>
		<main id="main">
		...
		<script type="application/javascript">
			...
			$("#submit-btn").click(function(){
				...
				if(old_pwd==""||new_pwd==""||repeat_pwd==""){
					...
					$.ajax({
					type: "POST",
					url: "action/modifypwd.class.php",
					data: {uid:<?php echo $_SESSION['C_USER']->mId;?>,oldpwd:old_pwd,newpwd:new_pwd
					},
					dataType: "json",
