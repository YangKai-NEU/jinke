<?php
	...
	$conne->init_conn();
	$isself=$_SESSION['C_USER']->mIsSelf;
	$uid=$_SESSION['C_USER']->mId;
	if($isself=='Y'){
...
<html>
	<head>
		...
		<title><?php echo $confige->getItem('account_title');?>-个人信息</title>
	</head>
	<body>
		...
		<div class='account-main'>
			<div class='account-main-left cur-hand'>
				...
				<div id="account-main-left-selfinfosetting" class="account-text-b text-red cur-hand font17px">个人信息设置</div>
				...
				<div id="account-main-left-message" class="account-text-b mouse-on-red-off-black cur-hand">我的消息</div>
			...
			<div class="account-main-mid">
				<?php
						if($isself=='Y'){
					?>
					<div class="info-item"><div class="info-item-left">姓名：</div><input id="self-name" class="info-item-right" type="text" value="<?php echo $array[0]['s_name'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">性别：</div><input id="self-sex" class="info-item-right" type="text" value="<?php echo $array[0]['s_sex'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">身份证号：</div><input id="self-idcard" class="info-item-right" type="text" value="<?php echo $array[0]['s_idcard'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">地址：</div><input id="self-address" class="info-item-right" type="text" value="<?php echo $array[0]['s_address'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">户籍：</div><input id="self-huji" class="info-item-right" type="text" value="<?php echo $array[0]['s_huji'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">婚姻状况：</div><input id="self-hunyin" class="info-item-right" type="text" value="<?php echo $array[0]['s_hunyin'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">公司：</div><input id="self-workspace" class="info-item-right" type="text" value="<?php echo $array[0]['s_workspace'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">公司地址：</div><input id="self-workaddress" class="info-item-right" type="text" value="<?php echo $array[0]['s_workaddress'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">公司电话：</div><input id="self-workphone" class="info-item-right" type="text" value="<?php echo $array[0]['s_workphone'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">联系人1：</div><input id="self-lianxiren1" class="info-item-right" type="text" value="<?php echo $array[0]['s_lianxiren1'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">联系人2：</div><input id="self-lianxiren2" class="info-item-right" type="text" value="<?php echo $array[0]['s_lianxiren2'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">学费：</div><input id="self-xuefei" class="info-item-right" type="text" value="<?php echo $array[0]['s_xuefei'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">月收入：</div><input id="self-yueshouru" class="info-item-right" type="text" value="<?php echo $array[0]['s_yueshouru'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">是否学生：</div><input id="self-isstudent" class="info-item-right" type="text" value="<?php echo $array[0]['s_isstudent'];?>"></input></div>
					<?php
						}else{
					?>
					<div class="info-item"><div class="info-item-left">姓名：</div><input id="qiye-name" class="info-item-right" type="text" value="<?php echo $array[0]['q_name'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">性别：</div><input id="qiye-sex" class="info-item-right" type="text" value="<?php echo $array[0]['q_sex'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">地址：</div><input id="qiye-address" class="info-item-right" type="text" value="<?php echo $array[0]['q_address'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">户籍：</div><input id="qiye-huji" class="info-item-right" type="text" value="<?php echo $array[0]['q_huji'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">身份证号：</div><input id="qiye-idcard" class="info-item-right" type="text" value="<?php echo $array[0]['q_idcard'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">联系电话：</div><input id="qiye-phone" class="info-item-right" type="text" value="<?php echo $array[0]['q_phone'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">生日：</div><input id="qiye-birth" class="info-item-right" type="text" value="<?php echo $array[0]['q_birth'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">联系人1电话：</div><input id="qiye-lianxiren1" class="info-item-right" type="text" value="<?php echo $array[0]['q_lianxiren1'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">联系人2电话：</div><input id="qiye-lianxiren2" class="info-item-right" type="text" value="<?php echo $array[0]['q_lianxiren2'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">公司：</div><input id="qiye-workspace" class="info-item-right" type="text" value="<?php echo $array[0]['q_workspace'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">公司地址：</div><input id="qiye-workaddress" class="info-item-right" type="text" value="<?php echo $array[0]['q_workaddress'];?>"></input></div>
					<div class="info-item"><div class="info-item-left">公司电话：</div><input id="qiye-workphone" class="info-item-right" type="text" value="<?php echo $array[0]['q_workphone'];?>"></input></div>
					<?php
						}
					?>
					<input id="submit-info" type="button" class="cur-hand" style="margin:10px;float:right;width: 100px;height: 30px;background: dodgerblue;color: white;border: none;" value="确认修改"></input>
					<input id="edit-info" type="button" class="cur-hand" style="margin:10px;float:right;width: 100px;height: 30px;background: orangered;color: white;border: none;" value="编辑"></input>
			</div>
		</div>
		<main id="main">
		...
		<script type="application/javascript">
			...
			$("#submit-info").click(function(){
				...
				?>
				var jsonStr = {};
				jsonStr['mName']=$("#self-name").val();
				jsonStr['mSex']=$("#self-sex").val();
				jsonStr['mIdCard']=$("#self-idcard").val();
				jsonStr['mAddress']=$("#self-address").val();
				jsonStr['mHuji']=$("#self-huji").val();
				jsonStr['mHunyin']=$("#self-hunyin").val();
				jsonStr['mWorkSpace']=$("#self-workspace").val();
				jsonStr['mWorkAddress']=$("#self-workaddress").val();
				jsonStr['mWorkPhone']=$("#self-workphone").val();
				jsonStr['mLianxiren1']=$("#self-lianxiren1").val();
				jsonStr['mLianxiren2']=$("#self-lianxiren2").val();
				jsonStr['mXueFei']=$("#self-xuefei").val();
				jsonStr['mYueshouru']=$("#self-yueshouru").val();
				jsonStr['mIsStudent']=$("#self-isstudent").val();
				jsonStr['mId']=<?php echo $_SESSION['C_USER']->mId?>;
				var resultF=JSON.stringify(jsonStr);
				$.ajax({
					type: "POST",
					url: "action/submitself.class.php",
					data: {info:resultF
					},
					dataType: "json",
				...
				?>
				var jsonStr = {};
				jsonStr['mName']=$("#qiye-name").val();
				jsonStr['mSex']=$("#qiye-sex").val();
				jsonStr['mIdCard']=$("#qiye-idcard").val();
				jsonStr['mAddress']=$("#qiye-address").val();
				jsonStr['mHuji']=$("#qiye-huji").val();
				jsonStr['mPhone']=$("#qiye-phone").val();
				jsonStr['mBirth']=$("#qiye-birth").val();
				jsonStr['mWorkSpace']=$("#qiye-workspace").val();
				jsonStr['mWorkAddress']=$("#qiye-workaddress").val();
				jsonStr['mWorkPhone']=$("#qiye-workphone").val();
				jsonStr['mLianxiren1']=$("#qiye-lianxiren1").val();
				jsonStr['mLianxiren2']=$("#qiye-lianxiren2").val();
				jsonStr['mId']=<?php echo $_SESSION['C_USER']->mId?>;
				var resultF=JSON.stringify(jsonStr);
				$.ajax({
					type: "POST",
					url: "action/submitqiye.class.php",
					data: {info:resultF
					},
					dataType: "json",
					success: function(data) {
