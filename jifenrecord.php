<?php
	...
	$conne -> init_conn();
	$select = "select db_jifen_order.j_id,j_price,j_submittime,a_address,j_name,count(*) from db_jifen_goods,db_jifen_order,db_jifen_transaction,db_address where j_address=a_id and db_jifen_transaction.j_jgid=db_jifen_goods.j_id and 
		db_jifen_order.j_id=db_jifen_transaction.j_joid and j_isshow='N' and j_uid='".$_SESSION['C_USER']->mId."' group by j_joid";
...
<html>
	<head>
		...
		<title><?php echo $confige->getItem('homepage_title');?>-我的积分</title>
	</head>
	<body>
		...
		<div class='account-main'>
			<div class='account-main-left cur-hand'>
				...
				<div id="account-main-left-jifenrecord" class="account-text-b text-red cur-hand font17px">积分兑换记录</div>
