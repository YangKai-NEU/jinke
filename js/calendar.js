$(document).ready(function(e) {
	...
	$('#account-main-right-body-day').html(Stamp.getDate());
	$('#account-main-right-body-week').html(dayNames[Stamp.getDay()]);
...
var CalendarHandler = {
	...
	CreateCalendar: function(y, m, d) {
		...
		$('#account-main-right-body-month').html(nowYear+"/"+nowMonth);
